...
import com.example.user.surokkha.adapter.PillAdapter;

import java.util.ArrayList;

public class ShowPill extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
